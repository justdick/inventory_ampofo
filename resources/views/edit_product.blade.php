                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.5" placeholder="1 = 1 GHS | 0.5 = 50p" class="form-control wholesale_price" name="wholesale_price" value="{{$product['wholesale_price']}}" required>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.5" placeholder="1 = 1 GHS | 0.5 = 50p" class="form-control min_price" name="min_price" value="{{$product['min_price']}}" required>
                                    </div>
