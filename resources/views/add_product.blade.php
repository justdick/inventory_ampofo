                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="0.1" placeholder="1 = 1 GHS | 0.5 = 50p" class="form-control" name="wholesale_price" value="{{old('wholesale_price')}}" required>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="number" step="any" placeholder="1 = 1 GHS | 0.5 = 50p" class="form-control" name="min_price" value="{{old('min_price')}}" required>
                                    </div>
